...
#define ASI_ERR_INPROGRESS (ASI_ERR_INTERFACE | 0x22) /* a blocking Windows Sockets 1.1
call is in progress */
...
#define ASI_AUTO_ADDRESS_ASSIGN 0x04 /* automatic programming is
activated */
...
#define ASI_NORMAL_OPERATION_ACTIVE 0x20 /* the normal operation mode is
active */
...
*/
#define ASI_DATA_EXCHANGE_ACTIVE 0x01 /* bit reset: data exchange with the
slaves is locked */
#define ASI_OFFLINE 0x02 /* bit set: master is set to offline state */
#define ASI_AUTO_ADDRESS_ENABLE 0x04 /* bit set: automatic programming is
allowed */
...
#define ASI_CTRL_IGNORE_CONFIG_OK 0x04 /* bit set: configuration errors are
ignored */
#define ASI_CTRL_AUTO_START 0x08 /* bit set: automatic program start */
#define ASI_CTRL_COUNTER_MAP 0x10 /* bit set: the counters are mapped into user
data field */
#define ASI_CTRL_INPUT_FILTER 0x20 /* bit set: inputs are filtered */
#define ASI_CTRL_SYNCHRONIZE 0x40 /* bit set: controller program is synchronized with the
AS-Interface cycle */
...
*
*/
int EXP AASiInitDialog (int MasterID, LPCSTR FAR Drivers [], LPCSTR InitialSettings, LPCSTR
DisableSettings);
/*********************************************************************
*
* AASiExit(MasterID)
...
*/
int EXP AASiDataExchange (int MasterID, AASiProcessData FAR ODI, AASiProcessData FAR IDI,
AASiEcFlags FAR *EcFlags);
/*********************************************************************
*
...
* The flags are defined in aasidrv.h
*/
int EXP AASiReadIDI (int MasterID, AASiProcessData FAR IDI, AASiSlaveAddr First, unsigned char Amount,
AASiEcFlags FAR *EcFlags);
/*****************************************************************
*
...
* returns:
*/
int EXP AASiWriteODI (int MasterID, AASiProcessData FAR ODI, AASiSlaveAddr First, unsigned char
Amount);
/************************************************************
*
...
*/
int EXP AASiSendParameter (int MasterID, AASiSlaveAddr Address, AASiSlaveData PI, AASiSlaveData FAR
*Return);
/*********************************************************************
*
...
/*************************************************************
*
* error = AASiReadFaultDetector (MasterID, unsigned char *pucFaultDetectorActiv, unsigned char
*pucFaultDetectorHistoric);
*
* description:
...
*
*/
int EXP AASiReadFaultDetector (int MasterID, unsigned char *pucFaultDetectorActiv, unsigned char
*pucFaultDetectorHistoric);
/*********************************************************************
*
...
*/
int EXP AASiExecuteCommand (int MasterID, AASiSlaveAddr Address, AASiSlaveData Request,
AASiSlaveData FAR *Response);
/*********************************************************************
*
...
// wraps function below for the use with Visual Basic
int EXP VBAASiReadIDString(int MasterID, AASiSlaveAddr Address, unsigned char* IDString, unsigned int*
Length);
/*********************************************************************
*
...
*/
int EXP AASiReadIDString(int MasterID, AASiSlaveAddr Address, unsigned char **IDString, unsigned char
*Length);
// wraps function below for the use with Visual Basic
int EXP VBAASiReadDiagnosisString(int MasterID, AASiSlaveAddr Address, unsigned char*
DiagnosticString, unsigned int* Length);
/*********************************************************************
*
...
* Length: Pointer to an unsigned character holding the length of the string.
*/
int EXP AASiReadDiagnosticString(int MasterID, AASiSlaveAddr Address, unsigned char **DiagnosticString,
unsigned char *Length);
// wraps function below for the use with Visual Basic
int EXP VBAASiReadParameterString(int MasterID, AASiSlaveAddr Address, unsigned char*
ParameterString, unsigned int* Length);
/*********************************************************************
*
...
* Length: Pointer to an unsigned character holding the length of the string.
*/
int EXP AASiReadParameterString(int MasterID, AASiSlaveAddr Address, unsigned char **ParameterString,
unsigned char *Length);
/*********************************************************************
*
...
*
*/
int EXP AASiWriteParameterString(int MasterID, AASiSlaveAddr Address, unsigned char *ParameterString,
unsigned char Length);
/*********************************************************************
*
...
*/
int EXP AASiCtrlReadStatus (int MasterID, AASiCtrlFlags FAR *Status, unsigned short FAR *ActCycle,
unsigned short FAR *MaxCycle);
/*******************************************************************
*
...
*/
int EXP AASiCtrlReadMemory (int MasterID, AASiCtrlAddr Address, unsigned char Amount, AASiCtrlData
FAR Data);
/*************************************************************
*
...
* returns:
*/
int EXP AASiCtrlWriteMemory (int MasterID, AASiCtrlAddr Address, unsigned char Amount, AASiCtrlData
FAR Data);
/*************************************************************
*
...
* 2^2 = 1: Compare data of valid respones with 'Response' and count
...
*/
int EXP AASiWriteEmcSetup (int MasterID, unsigned char Flags, unsigned char Request, unsigned char
Response, unsigned long LAS);
/*************************************************************
*
...
*/
int EXP AASiUART (int MasterID, AASiSlaveAddr Address, BOOL SingleTransfer, AASiSlaveData Request,
AASiSlaveData *Response);
/*************************************************************
*
...
* ExpResLen: expected response length
*
* returns:
* Response: structure for mailbox response
*/
int EXP AASiMailbox (int MasterID, AASiMbRequestType Request, int ExpResLen, AASiMbResponseType
*Response);
#ifdef _WINDOWS /* { */
/*********************************************************************
*
